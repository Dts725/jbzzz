<template>
  <div class="app-container">
    <list :url="URL+url" dataKey="child" :update="update" :topBar="topBar" :canSelect="canSelect" :indexBar="indexBar" :thead="thead" :actionBarWidth="actionBarWidth" :actionBar="actionBar"></list>
    ...
    data() {
      return {
        ...
        thead: [{
          ...
          {
            name: "书记名称",
            key: 'organization_secretary_name',
            width: '110'
          },
          {
            name: "书记电话",
            key: 'organization_secretary_phone',
            width: 'auto'
          },
          {
            name: "联系人",
